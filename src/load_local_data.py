...
os.system('appcfg.py upload_data --config_file=bulkloader_book.yaml --filename=../data/books.csv --batch_size=50 --log_file=/dev/null --kind=Item --url=http://localhost:8080/remote_api .')
